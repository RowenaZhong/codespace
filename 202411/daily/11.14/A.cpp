...
int a1,b1,c1,d1,e1,f1,g1,h1,i1,j1,k1,l1,m1,n1,o1,p1,q1,r1,s1,t1,u1,v1,w1,x1;
bool Check()
{
    if(a!=b||b!=c||c!=d)return false;
    if(e!=f||f!=g||g!=h)return false;
    if(i!=j||j!=k||k!=l)return false;
    if(m!=n||n!=o||o!=p)return false;
    if(q!=r||r!=s||s!=t)return false;
    if(u!=v||v!=w||w!=x)return false;
    return true;
}
const int ROT_R=1;
const int ROT_r=2;
...
void Attempt(int m)
{
    a1=a,b1=b,c1=c,d1=d,e1=e,f1=f,g1=g,h1=h,i1=i,j1=j,k1=k,l1=l,m1=m,n1=n,o1=o,p1=p,q1=q,r1=r,s1=s,t1=t,u1=u,v1=v,w1=w,x1=x;
    switch(m)
    {
    case ROT_R:
